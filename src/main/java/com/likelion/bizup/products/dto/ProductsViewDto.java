...
//    public ProductsViewDto(Long id, String name, String price, Integer discountPrice, boolean discount, int discountAmount, Date startDate, Date endDate, boolean option, int optionAmount, List<ProductOptionDto> productOptionDtos, String shippingPrice, String category, String manufacturer, String title, String imgUrl, String description, LocalDate createAt, LocalDate updateAt) {
//        this.id = id;
//        this.name = name;
//        this.price = price;
//        this.discount = discount;
